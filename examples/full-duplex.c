/*
Example of use of gmsk-transfer's API to make a full-duplex link.
...
{
  gmsk_transfer_t *transfer = (gmsk_transfer_t *) arg;
...
int main(int argc, char **argv)
{
  ...
  downlink = gmsk_transfer_create(DOWNLINK_RADIO,
                                  0,
                                  NULL,
  ...
  uplink = gmsk_transfer_create(UPLINK_RADIO,
                                1,
                                NULL,
                                UPLINK_SAMPLE_RATE,
                                BIT_RATE,
